...
for filename in filelist:
	...
	strNumber = strLst [posToken].split (".")[0]
	ext       = strLst [posToken].split (".")[1]
	strNumberFilled = token + strNumber.zfill (nFill)

	newFilename = filename.replace (token+strNumber, strNumberFilled)
