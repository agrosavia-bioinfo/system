#!/usr/bin/python
# LG dropbox.py r1.1
# Customized by Luis Garreta
# Reads ~/tmp/dropbox-home.txt for current dropbox account
#
import errno, locale, optparse, os, platform, shutil, socket, StringIO
import subprocess, sys, tarfile, tempfile, threading, thread
import time, traceback, urllib2

# Luis G: Set HOME to DROPBOX HOME
current_dropbox_file = "/home/lg/tmp/config/dropbox-home.txt"
if os.path.exists (current_dropbox_file):
	os.environ ['HOME'] = open (current_dropbox_file).readlines()[0].strip()
